...
export const fetchAllSearchData = createAsyncThunk<string[]>(
  "searchFeature/fetchSearchAPIData",
  async () => {
...
export const startSearching = createAsyncThunk(
  ...
  async (searchQuery: string) => {
    const response = await axios.get(SearchProductDataURL, {
...
const searchFeatureSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(
        fetchTrendingSearches.fulfilled,
